class Person {
    ...
    childOf() {
        return `${this.name}'s parents are ${this.parents[0] ? this.parents[0] : "unknown" } ${this.parents[1] ? "and" + this.parents[1] : ""}`;
    }
}
...
console.log(MeghanWindsor.childOf());

// module.exports = royalFamily;
module.exports = { royalFamily, WilliamWindsor };